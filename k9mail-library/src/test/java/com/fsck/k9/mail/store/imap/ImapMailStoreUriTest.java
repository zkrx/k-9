...
public class ImapMailStoreUriTest {
    @Test
    public void testDecodeStoreUriImapNoAuth() {
        String uri = "imap://user:pass@server/";
        
        ServerSettings settings = RemoteMailStore.decodeStoreUri(uri);
    ...
    public void testCreateStoreUriImapPrefix() {
        ...
        String uri = RemoteMailStore.createStoreUri(settings);
    ...
    public void testCreateDecodeStoreUriWithSpecialCharactersInUsernameAndPassword() {
        ...
        ServerSettings outSettings = RemoteMailStore.decodeStoreUri(uri);
