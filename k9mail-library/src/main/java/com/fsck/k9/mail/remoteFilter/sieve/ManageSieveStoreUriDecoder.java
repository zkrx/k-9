...
class ManageSieveStoreUriDecoder {
    /**
     ...
     */
    public static ManageSieveStoreSettings decode(String uri) {
        String host;
        int port;
        ...
        return new ManageSieveStoreSettings(host, port, connectionSecurity, authenticationType, username,
