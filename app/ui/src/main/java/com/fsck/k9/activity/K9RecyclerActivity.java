...
public abstract class K9RecyclerActivity<VH extends RecyclerView.ViewHolder> extends K9Activity implements K9ActivityMagic {
...
*/
    ...
    protected void setListAdapter(Adapter<VH> listAdapter) {
        if (list == null) {
            list = findViewById(android.R.id.list);
        }
